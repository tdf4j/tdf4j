...
import io.github.tdf4j.core.model.ebnf.Repeat;
...
public class RepeatAdaptor implements ModelAdaptor {
    ...
    public Object getProperty(final Interpreter interp, final ST self, final Object o, final Object property, final String propertyName) throws STNoSuchPropertyException {
        ...
        switch (propertyName) {
            case "start" : return getStartElements(repeat);
            case "elements" : return repeat.getElements();
            default : throw new STNoSuchPropertyException(null, repeat, propertyName);
        }
    }
