...
import org.tdf4j.core.model.ebnf.OneOf;
import org.tdf4j.core.utils.Elements;

public class OneOfAdaptor implements ModelAdaptor {
    ...
    public Object getProperty(final Interpreter interpreter, final ST st, final Object o, final Object property, final String propertyName) throws STNoSuchPropertyException {
        ...
        switch (propertyName) {
            case "alternatives" : return oneOf.getAlternatives();
            case "start" : return Elements.getStartElements(oneOf);
            default : throw new STNoSuchPropertyException(null, oneOf, propertyName);
        }
    }
