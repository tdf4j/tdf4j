...
public class OrAdaptor implements ModelAdaptor {
    ...
    public Object getProperty(final Interpreter interp, final ST self, final Object o, final Object property, final String propertyName) throws STNoSuchPropertyException {
        final Or or = (Or) o;
        switch (propertyName) {
            case "firstStart" : return Elements.getStartElements(or.getFirst());
            case "secondStart" : return Elements.getStartElements(or.getSecond());
            case "first" : return or.getFirst();
            case "second" : return or.getSecond();
