...
public class ValidatorImpl<T extends Module> implements Validator<T> {
    final ValidatorStrategy<T> strategy;

    public ValidatorImpl(final ValidatorStrategy<T> strategy) {
        this.strategy = strategy;
    }

    @Override
    public void validate(final T module) throws ValidatorException {
        strategy.apply(module);
    }
}
