...
public class EnvTest extends TdfParserTest {
    ...
    public void test() {
        ...
        assertEquals("io.github.tdf4j.core.model.Token", environment.getPackages()[0]);
        assertEquals("io.github.tdf4j.core.module.LexerAbstractModule", environment.getPackages()[1]);
